...
function EZOP_SetAct_ClearOperation(f1_arg0, f1_arg1)
    ...
    return { EZOP_OPERATION.CLEAR_OPERATION, max_action_duration, { nil }, { { TransAct } }, false }
end
...
function EZOP_SetAct_ApproachTarget_NoNavi(ai, max_action_duration, target, f4_arg3, f4_arg4, desired_target_distance,
                                           f4_arg6,
                                           f4_arg7,
    ...
    return { EZOP_OPERATION.MOVE_APPROACH, max_action_duration, { f4_arg6, max_action_duration, target, f4_arg4, f4_arg3, desired_target_distance, f4_arg7, f4_arg8, false }, { { f4_arg11, EZOP_OpEndChk_CloserThan, { target, desired_target_distance, EZOP_ARRIVE_JUDGE_TYPE._CapsuleToCapsule } }, { f4_local0 } }, true, { f4_arg9, f4_arg10 } }
end

function EZOP_SetAct_ApproachTarget_NoNavi_SandWorm(ai, max_action_duration, f5_arg2, f5_arg3, f5_arg4, f5_arg5, f5_arg6,
    ...
    return { EZOP_OPERATION.MOVE_APPROACH, max_action_duration, { f5_arg6, max_action_duration, f5_arg2, f5_arg4, f5_arg3, f5_arg5, f5_arg7, f5_arg8, false }, { { f5_arg11, EZOP_OpEndChk_CloserThanXZ, { f5_arg2, f5_arg5, EZOP_ARRIVE_JUDGE_TYPE._CapsuleToCapsule } }, { f5_local0 } }, true, { f5_arg9, f5_arg10 } }
end

function EZOP_SetAct_LeaveTarget(ai, max_action_duration, target, turn_target_type, movement_type, desired_distance,
                                 actions_to_take_once_far_enough, interrupt_setup_func, interrupt_handlers, CheckFunc_arg,
                                 CheckParam_arg)
    --This behavior of CheckFunc_arg being set to nil, which then becomes "next" (or alternatively, being set to TransAct, which equals "next", directly)
    --Is made to completely override the Check function with a value of your choosing.
    --NOTE: Only certain functions support this.
    if CheckFunc_arg == nil then
        CheckFunc_arg = "next"
    end
    local Check_Override_Value = nil
    if CheckParam_arg == true then
        Check_Override_Value = CheckFunc_arg
    end
    return { EZOP_OPERATION.MOVE_LEAVE,
        max_action_duration,
        { actions_to_take_once_far_enough, max_action_duration, target, movement_type, turn_target_type, desired_distance, interrupt_setup_func, interrupt_handlers },
        { { CheckFunc_arg,     EZOP_OpEndChk_FartherThan, { target, desired_distance, EZOP_ARRIVE_JUDGE_TYPE._CapsuleToCapsule } },
            { Check_Override_Value } },
        false,
        { CheckFunc_arg,                   CheckParam_arg } }
end

function EZOP_SetAct_SideWayMove(f7_arg0, max_action_duration, f7_arg2, f7_arg3, f7_arg4, f7_arg5, f7_arg6, f7_arg7,
                                 f7_arg8, f7_arg9,
                                 f7_arg10, f7_arg11)
    if f7_arg11 == nil then
        f7_arg11 = "next"
    end
    return { EZOP_OPERATION.MOVE_SIDEWAY, max_action_duration, { f7_arg6, max_action_duration, f7_arg2, f7_arg4, f7_arg5, f7_arg3, f7_arg7, f7_arg8 }, { { f7_arg11 } }, false, { f7_arg9, f7_arg10 } }
end

function EZOP_SetAct_CommonMove(ai, max_action_duration, target, turn_type, movement_type, f8_arg5, run_on_end,
...
function EZOP_SetAct_CommonMove_Air(f9_arg0, max_action_duration, f9_arg2, f9_arg3, f9_arg4, f9_arg5, f9_arg6, f9_arg7,
                                    f9_arg8,
                                    f9_arg9, f9_arg10, f9_arg11)
    if f9_arg11 == nil then
        f9_arg11 = "next"
    end
    return { EZOP_OPERATION.MOVE_COMMON_FOMAL, max_action_duration, { f9_arg6, max_action_duration, f9_arg2, f9_arg4, f9_arg5, f9_arg3, f9_arg7, f9_arg8, AI_NAVIGATE_SEARCH_TYPE_VOLUME }, { { f9_arg11 } }, false, { f9_arg9, f9_arg10 } }
end

function EZOP_SetAct_MoveFloatNoNavi(f10_arg0, max_action_duration, f10_arg2, f10_arg3, f10_arg4, f10_arg5, f10_arg6,
                                     f10_arg7,
                                     f10_arg8, f10_arg9, f10_arg10, f10_arg11, f10_arg12, f10_arg13, f10_arg14, f10_arg15)
    if f10_arg14 == nil then
        f10_arg14 = "next"
    end
    return { EZOP_OPERATION.MOVE_FLOAT_NONAVI, max_action_duration, { f10_arg13, max_action_duration, f10_arg2, f10_arg3, f10_arg4, f10_arg5, f10_arg6, f10_arg7, f10_arg8, f10_arg9, f10_arg10, f10_arg11, f10_arg12 }, { { f10_arg14 } }, false, { ChkFunc, ChkParam } }
end

function EZOP_SetAct_ApproachBoostRise(f11_arg0, max_action_duration, f11_arg2, f11_arg3, f11_arg4, f11_arg5, f11_arg6,
                                       f11_arg7,
    ...
    return { EZOP_OPERATION.MOVE_BOOST_RISE, max_action_duration, { f11_arg9, max_action_duration, f11_arg2, f11_arg7, f11_arg6, f11_arg3, f11_arg4, f11_arg5, f11_arg8, f11_arg10, f11_arg11, f11_arg16 }, { { f11_arg14, EZOP_OpEndChk_CloserThan, { f11_arg2, f11_arg8, EZOP_ARRIVE_JUDGE_TYPE._CapsuleToCapsule } }, { f11_local0 } }, false, { f11_arg12, f11_arg13 } }
end

function EZOP_SetAct_QuickBoost(ai, max_action_duration, target, angle_relative_to_target, actions_arg, ChkFunc_arg,
                                ChkFuncParam_arg)
    if TransAct == nil then
        TransAct = "next"
    end
    return { EZOP_OPERATION.QUICK_BOOST_FORMAL,
        max_action_duration,
        { angle_relative_to_target, max_action_duration, target, EZOP_MOVETYPE._QB_FORMAL, max_action_duration, 1, InterruptSetupFunc, InterruptFunc },
        { { TransAct } },
        false,
        { ChkFunc_arg, ChkFuncParam_arg } }
end

function EZOP_SetAct_QuickBoostAlt(f13_arg0, max_action_duration, f13_arg2, f13_arg3, f13_arg4, f13_arg5, f13_arg6,
                                   f13_arg7,
                                   f13_arg8, f13_arg9)
    if f13_arg9 == nil then
        f13_arg9 = "next"
    end
    return { EZOP_OPERATION.QUICK_BOOST_FORMAL, max_action_duration, { f13_arg4, max_action_duration, f13_arg2, EZOP_MOVETYPE._QB_FORMAL, f13_arg3, 2, f13_arg7, f13_arg8 }, { { f13_arg9 } }, false, { f13_arg5, f13_arg6 } }
end

function EZOP_SetAct_NPC_AssultBoost(f14_arg0, max_action_duration, f14_arg2, f14_arg3, f14_arg4, f14_arg5, f14_arg6,
                                     f14_arg7,
                                     f14_arg8, f14_arg9, f14_arg10, f14_arg11, f14_arg12, f14_arg13, f14_arg14)
    if f14_arg14 == nil then
        f14_arg14 = "next"
    end
    return { EZOP_OPERATION.ASSULT_BOOST, max_action_duration, { f14_arg9, max_action_duration, f14_arg2, EZOP_MOVETYPE._ASSULT_BOOST, f14_arg3, f14_arg2, f14_arg12, f14_arg13, f14_arg4, f14_arg8 }, { { f14_arg14, EZOP_OpEndChk_CloserThan, { f14_arg2, f14_arg5, EZOP_ARRIVE_JUDGE_TYPE._CapsuleToCapsule } }, { f14_arg14 } }, false, { f14_arg10, f14_arg11 } }
end

function EZOP_SetAct_Turn(f15_arg0, max_action_duration, f15_arg2, f15_arg3, f15_arg4, f15_arg5, f15_arg6)
    if f15_arg6 == nil then
        f15_arg6 = "next"
    end
    return { EZOP_OPERATION.TURN_FORMAL, max_action_duration, { f15_arg3, max_action_duration, f15_arg2, EZOP_MOVETYPE._TURN_FORMAL, 1 }, { { f15_arg6, EZOP_OpEndChk_IsInsideAngle, { f15_arg2, 60, AI_DIR_TYPE_F } }, { f15_arg6 } }, true, { f15_arg4, f15_arg5 },
        AI_ORDER_TYPE_ONESHOT }
end

function EZOP_SetAct_Relative_Turn(f16_arg0, max_action_duration, f16_arg2, f16_arg3, f16_arg4, f16_arg5, f16_arg6,
                                   f16_arg7)
    if f16_arg7 == nil then
        f16_arg7 = "next"
    end
    return { EZOP_OPERATION.RELATIVE_TURN, max_action_duration, { f16_arg4, max_action_duration, f16_arg2, EZOP_MOVETYPE._RELATIVE_TURN, 1, f16_arg3 }, { { f16_arg7 } }, true, { f16_arg5, f16_arg6 },
        AI_ORDER_TYPE_ONESHOT }
end

function EZOP_SetAct_QBTurn(f17_arg0, max_action_duration, f17_arg2, f17_arg3, f17_arg4, f17_arg5, f17_arg6)
    if f17_arg6 == nil then
        f17_arg6 = "next"
    end
    return { EZOP_OPERATION.TURN_FORMAL, max_action_duration, { f17_arg3, max_action_duration, f17_arg2, EZOP_MOVETYPE._TURN_FORMAL, 2 }, { { f17_arg6 } }, true, { f17_arg4, f17_arg5 } }
end

function EZOP_SetAct_LoopTurn(f18_arg0, max_action_duration, f18_arg2, f18_arg3, f18_arg4, f18_arg5, f18_arg6, f18_arg7,
                              f18_arg8)
    if f18_arg8 == nil then
        f18_arg8 = "next"
    end
    return { EZOP_OPERATION.LOOPTURN_FORMAL, max_action_duration, { f18_arg5, max_action_duration, f18_arg2, EZOP_MOVETYPE._LOOPTURN_FORMAL, f18_arg4 }, { { f18_arg8, EZOP_OpEndChk_InsideRange, { f18_arg3, f18_arg4, -1, 9999999 } }, { f18_arg8 } }, true, { f18_arg6, f18_arg7 } }
end

function EZOP_SetAct_Jump(f19_arg0, max_action_duration, f19_arg2, f19_arg3, f19_arg4, f19_arg5, f19_arg6, f19_arg7,
                          f19_arg8)
    if f19_arg8 == nil then
        f19_arg8 = "next"
    end
    return { EZOP_OPERATION.JUMP_FORMAL, max_action_duration, { f19_arg5, max_action_duration, f19_arg2, EZOP_MOVETYPE._JUMP_FORMAL, f19_arg3, f19_arg4 }, { { f19_arg8 } }, false, { f19_arg6, f19_arg7 } }
end

function EZOP_SetAct_LoopJump(f20_arg0, max_action_duration, f20_arg2, f20_arg3, f20_arg4, f20_arg5, f20_arg6, f20_arg7,
                              f20_arg8)
    if f20_arg8 == nil then
        f20_arg8 = "next"
    end
    return { EZOP_OPERATION.JUMP_FORMAL, max_action_duration, { f20_arg5, max_action_duration, f20_arg2, EZOP_MOVETYPE._LOOPJUMP_FORMAL, f20_arg3, f20_arg4 }, { { f20_arg8 } }, false, { f20_arg6, f20_arg7 } }
end

function EZOP_SetAct_NPAC_Hover(f21_arg0, max_action_duration, f21_arg2, f21_arg3, f21_arg4, f21_arg5, f21_arg6, f21_arg7)
    if f21_arg7 == nil then
        f21_arg7 = "next"
    end
    IsExecHover = 1
    return { EZOP_OPERATION.NPAC_HOVER, max_action_duration, { f21_arg4, max_action_duration, f21_arg2, EZOP_MOVETYPE._NPAC_HOVER, f21_arg3, IsExecHover }, { { f21_arg7 } }, false, { f21_arg5, f21_arg6 } }
end

function EZOP_SetAct_StandShoot(f22_arg0, max_action_duration, f22_arg2, f22_arg3, f22_arg4, f22_arg5, f22_arg6, f22_arg7,
                                f22_arg8,
                                f22_arg9)
    ...
    return { EZOP_OPERATION.COMMON_UPPERBODY_ATTACK, max_action_duration, { f22_arg3, max_action_duration, f22_arg2, f22_arg6, f22_arg7 }, { { f22_local0 } }, false, { f22_arg4, f22_arg5 } }
end

function EZOP_SetAct_Melee(f23_arg0, max_action_duration, f23_arg2, f23_arg3, f23_arg4, f23_arg5, f23_arg6, f23_arg7,
                           f23_arg8)
    ...
    return { EZOP_OPERATION.COMMON_STAND_ATTACK, max_action_duration, { f23_local2, max_action_duration, f23_arg2 }, { { f23_local0 } }, false, { f23_arg5, f23_arg6 } }
end

function EZOP_SetAct_ComboMelee(f24_arg0, max_action_duration, f24_arg2, f24_arg3, f24_arg4, f24_arg5, f24_arg6, f24_arg7,
                                f24_arg8)
    ...
    return { EZOP_OPERATION.COMMON_STAND_ATTACK, max_action_duration, { f24_local2, max_action_duration, f24_arg2 }, { { f24_local0 } }, false, { f24_arg5, f24_arg6 } }
end

function EZOP_SetAct_MultiAttack(f25_arg0, max_action_duration, f25_arg2, f25_arg3, f25_arg4, f25_arg5, f25_arg6,
                                 f25_arg7)
    ...
    return { EZOP_OPERATION.COMMON_STAND_ATTACK, max_action_duration, { f25_arg3, max_action_duration, f25_arg2 }, { { f25_local0 } }, false, { f25_arg4, f25_arg5 } }
end

function EZOP_ReverseFunction_OpEndChk(f26_arg0, max_action_duration, f26_arg2)
    function Func_rev(f27_arg0, max_action_duration, f27_arg2)
        return not f26_arg1(f27_arg0, max_action_duration, f27_arg2)
    end

    return Func_rev
end

function EZOP_SetAct_ActBranch(f28_arg0, max_action_duration, f28_arg2, f28_arg3, f28_arg4)
    local f28_local0 = EZOP_ReverseFunction_OpEndChk(f28_arg0, max_action_duration, f28_arg2)
    return { EZOP_OPERATION.WAIT, 0.2, {}, { { f28_arg3, max_action_duration, f28_arg2 }, { f28_arg4, f28_local0, f28_arg2 }, { nil } }, true }
end

function EZOP_SetAct_CoverWait(f29_arg0, max_action_duration, f29_arg2, f29_arg3, f29_arg4, f29_arg5, f29_arg6)
    return { EZOP_OPERATION.WAIT, max_action_duration, {}, { { f29_arg6, EZOP_OpEndChk_PointCheck_Cover, { POINT_AIDestPoint_Reserve, f29_arg3, f29_arg4, f29_arg5 } }, { "next" } }, true }
end

function EZOP_SetAct_SearchCoverPoint(f30_arg0, max_action_duration, f30_arg2, f30_arg3, f30_arg4, f30_arg5, f30_arg6,
                                      f30_arg7)
    ...
    return { EZOP_OPERATION.SEARCH_COVER_POINT, max_action_duration, { f30_arg5, max_action_duration, f30_arg2, f30_arg3, f30_arg4 }, { { f30_arg6, EZOP_OpEndChk_SearchCoverPoint, { f30_arg2, f30_arg3, f30_arg4 } }, { nil, EZOP_OpEndChk_SearchCoverPoint_PathCheckForceEnd, { f30_arg2, f30_arg3, f30_arg4 } }, { f30_local0 } }, false }
end

function EZOP_SetAct_SearchMovePointAsync(f31_arg0, max_action_duration, f31_arg2, f31_arg3, f31_arg4, f31_arg5, f31_arg6,
                                          f31_arg7)
    ...
    return { EZOP_OPERATION.SEARCH_MOVE_POINT, max_action_duration, { f31_arg5, max_action_duration, f31_arg2, f31_arg3, f31_arg4 }, { { f31_arg6, EZOP_OpEndChk_SearchMovePoint, { f31_arg2, f31_arg3, f31_arg4 } }, { f31_local0 } }, false }
end

function EZOP_SetAct_SearchShootAssetPoint(f32_arg0, max_action_duration, f32_arg2, f32_arg3, f32_arg4, f32_arg5,
                                           f32_arg6, f32_arg7)
    ...
    return { EZOP_OPERATION.SEARCH_SHOOTASSET_POINT, max_action_duration, { f32_arg5, max_action_duration, f32_arg2, f32_arg3, f32_arg4 }, { { f32_arg6, EZOP_OpEndChk_SearchShootAssetPoint, { f32_arg2, f32_arg3, f32_arg4 } }, { nil, EZOP_OpEndChk_SearchShootAssetPoint_PathCheckForceEnd, { f32_arg2, f32_arg3, f32_arg4 } }, { f32_local0 } }, false }
end

function EZOP_SetAct_SnipeWait(f33_arg0, max_action_duration, f33_arg2, f33_arg3, f33_arg4, f33_arg5, f33_arg6)
    return { EZOP_OPERATION.WAIT, max_action_duration, {}, { { f33_arg6, EZOP_OpEndChk_PointCheck_Snipe, { POINT_AIDestPoint_Reserve, f33_arg3, f33_arg4, f33_arg5 } }, { "next" } }, true }
end

function EZOP_SetAct_WaitSpecialEffect(f34_arg0, max_action_duration, f34_arg2, f34_arg3, f34_arg4, f34_arg5)
    ...
    return { EZOP_OPERATION.WAIT, max_action_duration, {}, { { f34_arg4, EZOP_OpEndChk_HasSpecialEffect, { f34_arg2, f34_arg3 } }, { f34_local0 } }, true }
end

function EZOP_SetAct_WaitForLanding(f35_arg0, max_action_duration, f35_arg2, f35_arg3, f35_arg4)
    ...
    return { EZOP_OPERATION.WAIT, max_action_duration, {}, { { f35_arg3, EZOP_OpEndChk_IsLanding, { f35_arg2 } }, { f35_local0 } }, true }
end

function EZOP_SetAct_WaitForChkHeight(f36_arg0, max_action_duration, f36_arg2, f36_arg3, f36_arg4, f36_arg5, f36_arg6)
    ...
    return { EZOP_OPERATION.WAIT, max_action_duration, {}, { { f36_arg5, EZOP_OpEndChk_ChkTargetHeight, { f36_arg2, f36_arg3, f36_arg4 } }, { f36_local0 } }, true }
end

function EZOP_SetAct_WaitForFuncCondition(f37_arg0, max_action_duration, f37_arg2, f37_arg3, f37_arg4, f37_arg5, f37_arg6)
    ...
    return { EZOP_OPERATION.WAIT, max_action_duration, {}, { { f37_arg5, f37_arg3, f37_arg4 }, { f37_local0 } }, true }
end

function EZOP_SetAct_CoverPointSearchWait(f38_arg0, max_action_duration, f38_arg2, f38_arg3)
    if f38_arg3 == nil then
        f38_arg3 = "next"
    end
    return { EZOP_OPERATION.WAIT, max_action_duration, {}, { { f38_arg3 } }, true }
end

function EZOP_SetAct_AbsorptionTargetPoint(f39_arg0, max_action_duration, f39_arg2, f39_arg3, f39_arg4, f39_arg5,
                                           f39_arg6, f39_arg7)
    ...
    return { EZOP_OPERATION.ABSORPTION_TARGETPOINT, max_action_duration, { f39_arg5, max_action_duration, f39_arg2, f39_arg3, f39_arg4 }, { { f39_arg6, EZOP_OpEndChk_CloserThan, { f39_arg2, f39_arg4, EZOP_ARRIVE_JUDGE_TYPE._Orrigin } }, { f39_local0 } }, true }
end

function EZOP_SetAct_TankTurn(f40_arg0, max_action_duration, f40_arg2, f40_arg3, f40_arg4, f40_arg5, f40_arg6)
    ...
    return { EZOP_OPERATION.TANKTURN, max_action_duration, { f40_arg5, max_action_duration, f40_arg2, f40_arg4, f40_arg3 }, { { f40_arg6, EZOP_OpEndChk_IsInsideAngle, { f40_arg2, f40_arg4, AI_DIR_TYPE_F } }, { f40_arg6 } }, true }
end

function EZOP_SetAct_KeepDistance_Navi(f41_arg0, max_action_duration, f41_arg2, f41_arg3, f41_arg4, f41_arg5, f41_arg6,
                                       f41_arg7,
    ...
    return { EZOP_OPERATION.MOVE_KEEPDIST_NAVI, max_action_duration, { f41_arg11, max_action_duration, f41_arg2, f41_arg3, f41_arg4, f41_arg5, f41_arg6, f41_arg7, f41_arg8, f41_arg9, f41_arg10 }, { { f41_arg12, EZOP_OpEndChk_CloserThan, { TARGET_LAST_MOVE_TARGET, f41_arg5, f41_arg6 } }, { f41_local0 } }, false }
end

function EZOP_SetAct_KeepDistance_Navi2(f42_arg0, max_action_duration, f42_arg2, f42_arg3, f42_arg4, f42_arg5, f42_arg6,
                                        f42_arg7,
    ...
    return { EZOP_OPERATION.MOVE_KEEPDIST_NAVI2, max_action_duration, { f42_arg11, max_action_duration, f42_arg2, f42_arg3, f42_arg4, f42_arg5, f42_arg6, f42_arg7, f42_arg8, f42_arg9, f42_arg10 }, { { f42_arg12, EZOP_OpEndChk_CloserThan, { TARGET_LAST_MOVE_TARGET, f42_arg5, f42_arg6 } }, { f42_local0 } }, false }
end

function EZOP_SetAct_KeepDistance_Navi3(f43_arg0, max_action_duration, f43_arg2, f43_arg3, f43_arg4, f43_arg5, f43_arg6,
                                        f43_arg7,
    ...
    return { EZOP_OPERATION.MOVE_KEEPDIST_NAVI3, max_action_duration, { f43_arg11, max_action_duration, f43_arg2, f43_arg3, f43_arg4, f43_arg5, f43_arg6, f43_arg7, f43_arg8, f43_arg9, f43_arg10 }, { { f43_arg12, EZOP_OpEndChk_CloserThan, { TARGET_LAST_MOVE_TARGET, f43_arg5, f43_arg6 } }, { f43_local0 } }, false }
end

function EZOP_SetAct_KeepDistance_Navi4(f44_arg0, max_action_duration, f44_arg2, f44_arg3, f44_arg4, f44_arg5, f44_arg6,
                                        f44_arg7,
    ...
    return { EZOP_OPERATION.MOVE_KEEPDIST_NAVI4, max_action_duration, { f44_arg13, max_action_duration, f44_arg2, f44_arg3, f44_arg4, f44_arg5, f44_arg6, f44_arg7, f44_arg8, f44_arg9, f44_arg10, f44_arg11, f44_arg12 }, { { f44_arg14, EZOP_OpEndChk_CloserThan, { TARGET_LAST_MOVE_TARGET, f44_arg5, f44_arg6 } }, { f44_local0 } }, false }
end

function EZOP_SetAct_KeepDistance_Navi5(f45_arg0, max_action_duration, f45_arg2, f45_arg3, f45_arg4, f45_arg5, f45_arg6,
                                        f45_arg7,
    ...
    return { EZOP_OPERATION.MOVE_KEEPDIST_NAVI5, max_action_duration, { f45_arg13, max_action_duration, f45_arg2, f45_arg3, f45_arg4, f45_arg5, f45_arg6, f45_arg7, f45_arg8, f45_arg9, f45_arg10, f45_arg11, f45_arg12 }, { { f45_arg16, EZOP_OpEndChk_CloserThan, { TARGET_LAST_MOVE_TARGET, f45_arg5, f45_arg6 } }, { f45_local0 } }, false, { f45_arg14, f45_arg15 } }
end

function EZOP_SetAct_KeepDistance_Navi5_SandWorm(f46_arg0, max_action_duration, f46_arg2, f46_arg3, f46_arg4, f46_arg5,
                                                 f46_arg6,
    ...
    return { EZOP_OPERATION.MOVE_KEEPDIST_NAVI5_SANDWORM, max_action_duration, { f46_arg13, max_action_duration, f46_arg2, f46_arg3, f46_arg4, f46_arg5, f46_arg6, f46_arg7, f46_arg8, f46_arg9, f46_arg10, f46_arg11, f46_arg12 }, { { f46_arg16, EZOP_OpEndChk_CloserThan, { TARGET_LAST_MOVE_TARGET, f46_arg5, f46_arg6 } }, { f46_local0 } }, false, { f46_arg14, f46_arg15 } }
end

function EZOP_SetAct_MoveRoutePoint(f47_arg0, max_action_duration, f47_arg2, f47_arg3, f47_arg4, f47_arg5, f47_arg6,
                                    f47_arg7,
                                    f47_arg8)
    ...
    return { EZOP_OPERATION.MOVE_ROUTE_POINT, max_action_duration, { f47_arg6, max_action_duration, POINT_MOVE_POINT, f47_arg3, f47_arg4, f47_arg5 }, { { f47_arg7, EZOP_OpEndChk_CloserThan_RoutePoint, { POINT_MOVE_POINT, f47_arg5, EZOP_ARRIVE_JUDGE_TYPE._Orrigin } }, { f47_local0 } }, false }
end

function EZOP_SetAct_MoveToCoverPoint(f48_arg0, max_action_duration, f48_arg2, f48_arg3, f48_arg4, f48_arg5, f48_arg6,
                                      f48_arg7,
    ...
    return { EZOP_OPERATION.MOVE_COVER_POINT, max_action_duration, { f48_arg8, max_action_duration, POINT_AIDestPoint_Reserve, f48_arg5, f48_arg6, f48_arg7, EZOP_ARRIVE_JUDGE_TYPE._Orrigin, f48_arg2, f48_arg3, f48_arg4, f48_arg9 }, { { f48_arg10, EZOP_OpEndChk_CloserThan, { POINT_AIDestPoint_Reserve, f48_arg7, EZOP_ARRIVE_JUDGE_TYPE._Orrigin } }, { nil, EZOP_OpEndChk_IsNotFinishTimer, { f48_arg3 } }, { f48_local0 } }, false }
end

function EZOP_SetAct_MoveToCoverPointAsync(f49_arg0, max_action_duration, f49_arg2, f49_arg3, f49_arg4, f49_arg5,
                                           f49_arg6, f49_arg7,
    ...
    return { EZOP_OPERATION.MOVE_COVER_POINT_ASYNC, max_action_duration, { f49_arg8, max_action_duration, POINT_AIDestPoint_Reserve, f49_arg5, f49_arg6, f49_arg7, EZOP_ARRIVE_JUDGE_TYPE._Orrigin, f49_arg2, f49_arg3, f49_arg4, f49_arg9 }, { { f49_arg10, EZOP_OpEndChk_CloserThan, { POINT_AIDestPoint_Reserve, f49_arg7, EZOP_ARRIVE_JUDGE_TYPE._Orrigin } }, { nil, EZOP_OpEndChk_IsNotFinishTimer, { f49_arg3 } }, { f49_local0 } }, false }
end

function EZOP_SetAct_MoveToMovePointAsync(f50_arg0, max_action_duration, f50_arg2, f50_arg3, f50_arg4, f50_arg5, f50_arg6,
                                          f50_arg7,
    ...
    return { EZOP_OPERATION.MOVE_MOVE_POINT_ASYNC, max_action_duration, { f50_arg8, max_action_duration, POINT_AIDestPoint_AiKeepRumtimePoint, f50_arg5, f50_arg6, f50_arg7, EZOP_ARRIVE_JUDGE_TYPE._Orrigin, f50_arg2, f50_arg3, f50_arg4, f50_arg9 }, { { f50_arg10, EZOP_OpEndChk_CloserThan, { POINT_AIDestPoint_AiKeepRumtimePoint, f50_arg7, EZOP_ARRIVE_JUDGE_TYPE._Orrigin } }, { nil, EZOP_OpEndChk_IsNotFinishTimer, { f50_arg3 } }, { f50_local0 } }, false }
end

function EZOP_SetAct_UroUroMove(f51_arg0, max_action_duration, f51_arg2, f51_arg3, f51_arg4, f51_arg5, f51_arg6, f51_arg7,
                                f51_arg8,
                                f51_arg9)
    ...
    return { EZOP_OPERATION.UROURO_MOVE, max_action_duration, { f51_arg7, max_action_duration, f51_arg2, f51_arg3, f51_arg4, f51_arg5, f51_arg6 }, { { f51_arg8, EZOP_OpEndChk_CloserThan, { TARGET_LAST_MOVE_TARGET, 2.5, f51_arg5 } }, { f51_local0 } }, false }
end

function EZOP_SetAct_MoveToShootAssetPointAsync(f52_arg0, max_action_duration, f52_arg2, f52_arg3, f52_arg4, f52_arg5,
                                                f52_arg6,
    ...
    return { EZOP_OPERATION.MOVE_SHOOTASSET_POINT_ASYNC, max_action_duration, { f52_arg8, max_action_duration, POINT_AIDestPoint_Reserve, f52_arg5, f52_arg6, f52_arg7, EZOP_ARRIVE_JUDGE_TYPE._Orrigin, f52_arg2, f52_arg3, f52_arg4, f52_arg9 }, { { f52_arg10, EZOP_OpEndChk_CloserThan, { POINT_AIDestPoint_Reserve, f52_arg7, EZOP_ARRIVE_JUDGE_TYPE._Orrigin } }, { nil, EZOP_OpEndChk_IsNotFinishTimer, { f52_arg3 } }, { f52_local0 } }, false }
end

function EZOP_SetAct_QuickBoost2(f53_arg0, max_action_duration, f53_arg2, f53_arg3, f53_arg4, f53_arg5, f53_arg6,
                                 f53_arg7)

end

function EZOP_SetAct_Jump2(f54_arg0, max_action_duration, f54_arg2, f54_arg3, f54_arg4, f54_arg5, f54_arg6, f54_arg7)
    if f54_arg7 == nil then
        f54_arg7 = "next"
    end
    return { EZOP_OPERATION.JUMP, max_action_duration, { f54_arg6, max_action_duration, f54_arg2, EZOP_MOVETYPE._JUMP2, f54_arg3 }, { { f54_arg7 } }, false }
end

function EZOP_SetAct_Jump3(f55_arg0, max_action_duration, f55_arg2, f55_arg3, f55_arg4, f55_arg5, f55_arg6, f55_arg7)
    if f55_arg7 == nil then
        f55_arg7 = "next"
    end
    return { EZOP_OPERATION.JUMP3, max_action_duration, { f55_arg6, max_action_duration, f55_arg2, EZOP_MOVETYPE._JUMP2, f55_arg3 }, { { f55_arg7 } }, false }
end

function EZOP_SetAct_ApproachTarget_FloatingFall(f56_arg0, max_action_duration, f56_arg2, f56_arg3, f56_arg4, f56_arg5,
                                                 f56_arg6,
    ...
    return { EZOP_OPERATION.FLOATING_FALL, max_action_duration, { f56_arg7, max_action_duration, f56_arg2, EZOP_MOVETYPE._FLOATING_FALL, f56_arg4, f56_arg5, f56_arg6, f56_arg3 }, { { f56_arg8, EZOP_OpEndChk_CloserThan, { f56_arg2, f56_arg4, f56_arg5 } }, { f56_local0 } }, false }
end

function EZOP_SetAct_ApproachTarget_Forward(f57_arg0, max_action_duration, f57_arg2, f57_arg3, f57_arg4, f57_arg5,
                                            f57_arg6,
    ...
    return { EZOP_OPERATION.MOVE_APPROACH_FORWARD, max_action_duration, { f57_arg10, max_action_duration, f57_arg2, f57_arg3, f57_arg4, f57_arg5, f57_arg6, f57_arg7, f57_arg8, f57_arg9 }, { { f57_arg11, EZOP_OpEndChk_CloserThan, { f57_arg2, f57_arg4, f57_arg5 } }, { f57_local0 } }, false }
end

function EZOP_SetAct_LeaveFromTarget_Forward(f58_arg0, max_action_duration, f58_arg2, f58_arg3, f58_arg4, f58_arg5,
                                             f58_arg6,
    ...
    return { EZOP_OPERATION.MOVE_LEAVE_FORWARD, max_action_duration, { f58_arg10, max_action_duration, f58_arg2, f58_arg3, f58_arg4, f58_arg5, f58_arg6, f58_arg7, f58_arg8, f58_arg9 }, { { f58_arg11, EZOP_OpEndChk_FartherThanXZ, { f58_arg2, f58_arg4, f58_arg5 } }, { f58_local0 } }, false }
end

function EZOP_SetAct_Attack(f59_arg0, max_action_duration, f59_arg2, f59_arg3, f59_arg4, f59_arg5, f59_arg6, f59_arg7,
                            f59_arg8)
    ...
    return { EZOP_OPERATION.ATTACK_1, max_action_duration, { max_action_duration, f59_arg2, f59_arg3, f59_arg4, f59_arg5 }, { { nil, EZOP_OpEndChk_IsNotFrontTarget_CancelFlagInterrupt, { f59_arg2, AI_DIR_TYPE_F, f59_local0, f59_local1 } }, { f59_arg8 } }, true }
end

function EZOP_SetAct_Attack2(f60_arg0, max_action_duration, f60_arg2, f60_arg3, f60_arg4, f60_arg5, f60_arg6, f60_arg7,
                             f60_arg8,
                             f60_arg9, f60_arg10, f60_arg11)
    if f60_arg11 == nil then
        f60_arg11 = "next"
    end
    return { EZOP_OPERATION.ATTACK_2, max_action_duration, { max_action_duration, f60_arg2, f60_arg3, f60_arg4, f60_arg5, f60_arg6, f60_arg7, f60_arg8, f60_arg9, OP_COMBO_TYPE_FALSE }, { { nil, EZOP_OpEndChk_IsNotFrontTarget_CancelFlagInterrupt, { f60_arg2, AI_DIR_TYPE_F, f60_arg9, f60_arg10 } }, { f60_arg11 } }, true }
end

function EZOP_SetAct_ComboAttack2(f61_arg0, max_action_duration, f61_arg2, f61_arg3, f61_arg4, f61_arg5, f61_arg6,
                                  f61_arg7,
                                  f61_arg8, f61_arg9, f61_arg10, f61_arg11)
    if f61_arg11 == nil then
        f61_arg11 = "next"
    end
    return { EZOP_OPERATION.ATTACK_2, max_action_duration, { max_action_duration, f61_arg2, f61_arg3, f61_arg4, f61_arg5, f61_arg6, f61_arg7, f61_arg8, f61_arg9, OP_COMBO_TYPE_TRUE }, { { nil, EZOP_OpEndChk_IsNotFrontTarget_CancelFlagInterrupt, { f61_arg2, AI_DIR_TYPE_F, f61_arg9, f61_arg10 } }, { f61_arg11 } }, true }
end

function EZOP_SetAct_MultiAttack2(f62_arg0, max_action_duration, f62_arg2, f62_arg3, f62_arg4, f62_arg5, f62_arg6,
                                  f62_arg7)
    ...
    return { EZOP_OPERATION.MULTI_ATTACK_2, max_action_duration, { f62_arg3, max_action_duration, f62_arg2 }, { { f62_local0 } }, false }
end

function EZOP_SetAct_MultiAttack3(f63_arg0, max_action_duration, f63_arg2, f63_arg3, f63_arg4, f63_arg5, f63_arg6,
                                  f63_arg7)
    ...
    return { EZOP_OPERATION.MULTI_ATTACK_3, max_action_duration, { f63_arg3, max_action_duration, f63_arg2 }, { { f63_local0 } }, false }
end

function EZOP_SetAct_CoverAttack(f64_arg0, max_action_duration, f64_arg2, f64_arg3, f64_arg4, f64_arg5, f64_arg6,
                                 f64_arg7, f64_arg8,
                                 f64_arg9, f64_arg10)
    ...
    return { EZOP_OPERATION.COVER_ATTACK, max_action_duration, { f64_arg3, max_action_duration, f64_arg2 }, { { nil, EZOP_OpEndChk_PointCheck_Cover, { POINT_AIDestPoint_Reserve, f64_arg4, f64_arg5, f64_arg6 } }, { f64_local0 } }, false }
end

function EZOP_SetAct_CoverAttack2(f65_arg0, max_action_duration, f65_arg2, f65_arg3, f65_arg4, f65_arg5, f65_arg6,
                                  f65_arg7,
...
function EZOP_SetAct_SwitchMode(f67_arg0, max_action_duration, f67_arg2, f67_arg3, f67_arg4)
    ...
    return { EZOP_OPERATION.SWITCH_MODE, max_action_duration, { max_action_duration, TARGET_NONE, f67_arg2, Param, "Beat" }, { { f67_arg4, EZOP_OpEndChk_SwitchMode, { TARGET_SELF, f67_local0, f67_arg3 } }, { f67_arg4 } }, true }
end

function EZOP_SetAct_AttackCharge(f68_arg0, max_action_duration, f68_arg2, f68_arg3, f68_arg4, f68_arg5, f68_arg6,
                                  f68_arg7,
                                  f68_arg8)
    ...
    return { EZOP_OPERATION.CHARGE_ATTACK, max_action_duration, { f68_arg2, f68_arg3, max_action_duration, 0 }, { { f68_arg8, EZOP_OpEndChk_IsFinishCharge, { f68_arg4, f68_arg2, f68_arg6, f68_arg7 } } }, true }
end

function EZOP_SetAct_RootMove(f69_arg0, max_action_duration, f69_arg2, f69_arg3, f69_arg4, f69_arg5, f69_arg6)
    if TransAct == nil then
        TransAct = "next"
    end
    return { EZOP_OPERATION.ROOT_MOVE, max_action_duration, { AttackArray, max_action_duration, f69_arg2, f69_arg3, f69_arg4, f69_arg5, f69_arg6 }, { nil }, true }
end
